// Lokasi: lib/halaman_pendukung/laporan_perundungan.dart
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:go_router/go_router.dart';
import 'laporan_step2.dart';

class LaporPerundunganPage extends StatefulWidget {
  const LaporPerundunganPage({super.key});

  @override
  State<LaporPerundunganPage> createState() => _LaporPerundunganPageState();
}

class _LaporPerundunganPageState extends State<LaporPerundunganPage> {
  ...
  void _handleNext() {
    if (_formKey.currentState!.validate()) {
      // TODO: Navigasi ke Step 2 (Langkah 2 dari 4)
      // Contoh jika menggunakan GoRouter:
      // context.push('/laporan-step2', extra: {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Melanjutkan ke langkah 2...'),
          backgroundColor: Color(0xFF1A6B8A),
        ),
      );
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const LaporanStep2Page()),
      );
    }
  }
      ...
      actions: [
        Padding(
          ...
          child: CircleAvatar(
            ...
            child: ClipOval(
              child: Container(color: const Color(0xFFE8D5C4)),
            ),
          ),
        ),
      ],
