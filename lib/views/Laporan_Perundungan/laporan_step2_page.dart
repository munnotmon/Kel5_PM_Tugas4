// Lokasi: lib/views/Laporan_Perundungan/LaporanStep2Page.dart
...
import 'laporan_widgets.dart'; // Sesuaikan path-nya jika berbeda
...
class _LaporanStep2PageState extends State<LaporanStep2Page> {
  ...
  void initState() {
    ...
    // Pre-fill field dari data sebelumnya ke Controller
    _laporanController.step2LokasiController.text = d['lokasi'] ?? '';
    _laporanController.step2DeskripsiController.text = d['deskripsi'] ?? '';
  ...
  @override
  void dispose() {
    _laporanController.disposeStep2();
    super.dispose();
  }
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          _laporanController.step2LokasiController.text =
  ...
  // =====================================================================
  // VALIDASI & NEXT (Menggunakan Controller)
  // =====================================================================
  void _handleNext() {
    _laporanController.processStep2(
      context,
      _formKey,
      widget.prevData,
      _selectedDateTime,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.bodyBg, // Ganti ke AppColors
      appBar: const LaporanAppBar(
        title: 'Laporkan Perundungan',
      ), // Gunakan Widget Shared
      body: SafeArea(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const LaporanPrivacyFooter(), // Gunakan Widget Shared
                const SizedBox(height: 24),
              ],
            ),
          ),
              ...
              children: [
                ...
                Text(
                  _selectedDateTime != null
                      ? _laporanController.formatDateTime(_selectedDateTime!)
                      : 'Pilih Tanggal & Jam',
                  style: GoogleFonts.plusJakartaSans(
                    fontSize: 14,
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: TextFormField(
                  controller: _laporanController.step2LokasiController,
                  validator: (val) =>
                  ...
                  decoration:
                      laporanInputDecoration(
                        'Cari atau pilih lokasi...',
                      ).copyWith(
                        // Gunakan Shared
                  ...
                  onTap: () {
                    setState(() {
                      ...
                      if (jenis == 'Cyberbullying') {
                        _laporanController.step2LokasiController.clear();
  ...
  Widget _buildDeskripsiKejadian() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        TextFormField(
          controller: _laporanController.step2DeskripsiController,
          maxLines: 5,
          style: GoogleFonts.plusJakartaSans(
            fontSize: 14,
            color: AppColors.darkText,
          ),
          decoration: laporanInputDecoration(
...
// =====================================================================
// HALAMAN MAP FULLSCREEN (Tetap Asli)
// =====================================================================
