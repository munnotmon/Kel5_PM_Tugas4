...
class _LaporanPerundunganPageState extends State<LaporanPerundunganPage> {
  ...
  void _handleNext() {
    if (_formKey.currentState!.validate()) {
      final laporanController = Provider.of<LaporanController>(context, listen: false);
      laporanController.updateStep1(
      ...
      if (isEdit) {
        context.push('/activity/laporan/step4', extra: safePrevData);
      } else {
        context.push('/activity/laporan/step2', extra: safePrevData);
      }
    }
  }
