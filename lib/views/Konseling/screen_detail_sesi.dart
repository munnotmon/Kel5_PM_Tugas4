    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // --- CATATAN SAYA ---
          _buildSectionHeader(Icons.edit_note_rounded, 'Catatan Saya'),
          const SizedBox(height: 12),
          _buildNoteBox(),
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Tuliskan hal-hal yang ingin kamu diskusikan dengan $_namaKonselor di sini...',
    ...
    return Column(
      children: [
        TextButton(
          ...
          child: Text('Ubah Jadwal', style: GoogleFonts.plusJakartaSans(fontSize: 16, fontWeight: FontWeight.bold, color: const Color(0xFF1068A3))),
        ),
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            ...
            child: Text('Batalkan Sesi', style: GoogleFonts.plusJakartaSans(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.redAccent)),
          ),
        )
      ],
    );
