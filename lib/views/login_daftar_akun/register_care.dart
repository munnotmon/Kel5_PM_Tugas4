// Lokasi: lib/views/login_daftar_akun/register_care.dart
...
class _RegisterCareState extends State<RegisterCare> {
  ...
  @override
  void dispose() {
    _authController.dispose(); // Gunakan dispose dari controller
    super.dispose();
  }
  ...
  void _register() {
    ...
    // Eksekusi logika register melalui controller
    _authController.processRegister(context, _formKey);
  }
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            controller: _authController.regFullNameController, // Gunakan Controller
                          ...
                          TextFormField(
                            controller: _authController.regUsernameController, // Gunakan Controller
                            onChanged: (value) => _resetSubmittedState(),
                            style: GoogleFonts.plusJakartaSans(),
                            decoration: PolinemaCareInputDecoration.get(
                          ...
                          TextFormField(
                            controller: _authController.regEmailController, // Gunakan Controller
                            onChanged: (value) => _resetSubmittedState(),
                            style: GoogleFonts.plusJakartaSans(),
                          ...
                          TextFormField(
                            controller: _authController.regPasswordController, // Gunakan Controller
