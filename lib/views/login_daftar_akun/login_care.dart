// Lokasi: lib/views/login_daftar_akun/login_care.dart
...
class _LoginCareState extends State<LoginCare> {
  ...
  void _login() {
    ...
    // Eksekusi logika login melalui controller
    _authController.processLogin(context, _formKey);
  }
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          TextFormField(
                            controller: _authController.loginEmailController, // Gunakan Controller
                            onChanged: (value) {
                              if (_isSubmitted) {
                                setState(() {
                                  _isSubmitted = false;
                          ...
                          const SizedBox(height: 8),
                          TextFormField(
                            controller: _authController.loginPasswordController, // Gunakan Controller
                          ...
                          SizedBox(
                            ...
                            child: OutlinedButton(
                              onPressed: () {
                                context.push('/google_account', extra: true);
                              },
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        highlightColor: const Color(0xFF1068A3).withOpacity(0.1),
