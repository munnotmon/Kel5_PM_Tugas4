// Lokasi: lib/views/login_daftar_akun/google_account.dart
...
class GoogleAccountSelection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final AuthController authController = AuthController(); // Gunakan Controller
  ...
  Widget _buildAccountCard({
    ...
    return InkWell(
      onTap: () {
        ...
        authController.processGoogleAccountSelection(context, isLogin, email);
      },
