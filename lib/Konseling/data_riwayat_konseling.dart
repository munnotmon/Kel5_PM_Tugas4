...
// Global list: Jika ada pemesanan baru, cukup tambahkan data ke list ini ( riwayatKonselingList.add(...) )
...
// Helper warna status agar otomatis sama di semua halaman sesuai permintaanmu
