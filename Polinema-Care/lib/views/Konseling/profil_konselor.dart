...
class _CounselorProfilePageState extends State<CounselorProfilePage> {
  ...
  void initState() {
    super.initState();
    final mapData = widget.counselorData ??
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: ElevatedButton.icon(
                onPressed: () {
                  if (_availableDates.isEmpty || selectedTime.isEmpty) {
                  ...
                  final selDateStr = _availableDates[selectedDate].toIso8601String().substring(0, 10);
                  ...
                  if (scheduleId == null) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text("Sesi jadwal tidak ditemukan!"),
                      ),
                    );
                    return;
                  }
                  ...
                  final cMap = counselor.toMap();
                  cMap['scheduleId'] = scheduleId;

                  context.push(
                    '/counseling/konfirmasi',
                    extra: {
                      'counselor': cMap,
                      'tanggal': finalSelectedDate,
                      'waktu': selectedTime,
                      'mode': selectedMode,
                    },
                  );
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: NetworkImage(
                  (counselor.fotoProfil != null && counselor.fotoProfil!.isNotEmpty)
                      ? counselor.fotoProfil!
  ...
  Widget _buildDatePicker() {
    ...
    if (_availableDates.isEmpty) {
      return Text(
        "Tidak ada jadwal praktek tersedia untuk saat ini.",
